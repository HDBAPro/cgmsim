var food = require('./last_meals.json');
var jsonfood = JSON.stringify(food);
var karbs = JSON.parse(jsonfood);
var carbrate = 0;
var COB = 0;

const carbAbsTime = 360; // meal absoption time in min
...
const CR = 15; // carb ration in g/U
...
const fs = require('fs');
fs.writeFile("latest_carbs.json", carbrateString, function(err, result) {
